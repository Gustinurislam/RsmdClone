    ...
    return (
        <>
            <div className="flex flex-col">
                <div className="h-20 xl:h-28 mt-auto bg-gradient-to-r from-primary to-[#439CC4] flex-between  text-white text-sm md:text-base lg:text-lg xl:text-2xl font-medium px-2 md:px-4 2xl:px-16">
